...
{{- else -}}
{{ .Release.Name }}-{{ .Values.nameOverride }}-{{ .Values.nodeGroup }}
{{- end -}}
{{- else -}}
...
{{- else -}}
{{ .Release.Name }}-{{ .Values.nameOverride }}-master
{{- end -}}
{{- else -}}
{{ .Release.Name }}-{{ .Values.fullnameOverride }}
{{- end -}}
{{- else -}}
{{ .Release.Name }}-{{ .Values.masterService }}
{{- end -}}
{{- end -}}
